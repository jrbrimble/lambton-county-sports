...
const dirNavRegex = /\{\/\* Top Navigation Bar \*\/\}\s*<nav className="w-full bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">[\s\S]*?<\/nav>\s*/;
...
const calNavRegex = /\{\/\* Top Navigation \*\/\}\s*<nav className="w-full bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">[\s\S]*?<\/nav>\s*/;
